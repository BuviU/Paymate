...
<section class="ld-onboarding-screen">
	<div class="ld-onboarding-main">
		...
		printf(
			...
			esc_html_x( 'You don\'t have any %s yet', 'placeholder: Topics', 'ebox' ),
		...
		<?php
				printf(
					// translators: placeholder: %1$s: modules, %2$s: Course, %3$s: Topics, %4$s: Topics, %5$s: Course, %6$s: Lesson.
					esc_html_x( 'When you have %1$s in your %2$s, you can break them up into separate %3$s. You can add %4$s using the %5$s Builder, or you can create them individually and assign them to a %6$s later.', 'placeholder: %1$s: modules, %2$s: Course, %3$s: Topics, %4$s: Topics, %5$s: Course, %6$s: Lesson', 'ebox' ),
		...
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=ebox-topic' ) ); ?>" class="button button-secondary">
			<span class="dashicons dashicons-plus-alt"></span>
			<?php
			printf(
				// translators: placeholder: Topic.
				esc_html_x( 'Add your first %s', 'placeholder: Topic', 'ebox' ),
				\ebox_Custom_Label::get_label( 'topic' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</a>
	...
	<div class="ld-onboarding-more-help">
		<div class="ld-onboarding-row">
			<div class="ld-onboarding-col">
				...
				printf(
					// translators: placeholder: Topics.
					esc_html_x( 'Creating %s', 'placeholder: Topics', 'ebox' ),
					\ebox_Custom_Label::get_label( 'topics' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
				);
				?>
				</h3>
			...
			<div class="ld-onboarding-col">
				<h3><?php esc_html_e( 'Related help and documentation', 'ebox' ); ?></h3>
					<ul>
						...
						<li><a href="https://arttricks.com.au/" target="_blank" rel="noopener noreferrer">
						<?php
							echo sprintf(
								// translators: placeholder: Topics.
								esc_html_x( '%s Documentation (only available in English)', 'placeholder: Topics', 'ebox' ),
								\ebox_Custom_Label::get_label( 'topics' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
							);
							?>
						</a></li>
