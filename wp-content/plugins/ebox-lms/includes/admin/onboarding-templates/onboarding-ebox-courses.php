...
<section class="ld-onboarding-screen">
	<div class="ld-onboarding-main">
		...
		printf(
			...
			esc_html_x( 'You don\'t have any %s yet', 'placeholder: Courses', 'ebox' ),
		...
		<p>
			<?php
			printf(
				// translators: placeholder: %1$s: Courses, %2$s: Course, %3$s: modules, %4$s: Topics, %5$s: Quizzes.
				esc_html_x( '%1$s offer a convenient and organized way for you to deliver training content. Create a %2$s and include %3$s, %4$s, %5$s, Assignments, and more!', 'placeholder: %1$s: Courses, %2$s: Course, %3$s: modules, %4$s: Topics, %5$s: Quizzes', 'ebox' ),
				\ebox_Custom_Label::get_label( 'courses' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
		...
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=ebox-courses' ) ); ?>" class="button button-secondary">
			<span class="dashicons dashicons-plus-alt"></span>
			<?php
			printf(
				// translators: placeholder: Course.
				esc_html_x( 'Add your first %s', 'placeholder: Course', 'ebox' ),
				\ebox_Custom_Label::get_label( 'course' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</a>
		...
		<div class="ld-onboarding-row">
			...
			<div class="ld-onboarding-col">
				...
				<ul>
					...
					echo sprintf(
						// translators: placeholder: Courses.
						esc_html_x( '%s Documentation (only available in English)', 'placeholder: Courses', 'ebox' ),
						ebox_Custom_Label::get_label( 'courses' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
					);
					?>
					</a></li>
			...
			<div class="ld-onboarding-col">
				...
				printf(
					// translators: Courses.
					esc_html_x( 'Getting started with ebox %s', 'placeholder: Courses', 'ebox' ),
					\ebox_Custom_Label::get_label( 'courses' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
				);
				?>
				</h3>
