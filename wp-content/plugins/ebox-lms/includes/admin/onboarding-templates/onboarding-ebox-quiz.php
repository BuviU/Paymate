...
<section class="ld-onboarding-screen">
	<div class="ld-onboarding-main">
		...
		printf(
			...
			esc_html_x( 'You don\'t have any %s yet', 'placeholder: Quizzes', 'ebox' ),
		...
		<p>
			<?php
				printf(
					...
					esc_html_x( '%1$s are a great way to check if your learners are understanding the %2$s content. You can have a %3$s in the middle of a %4$s, or you can put it at the end', 'placeholder: %1$s: Quizzes, %2$s: Course, %3$s: Quiz, %4$s: Course', 'ebox' ),
					\ebox_Custom_Label::get_label( 'quizzes' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
		...
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=ebox-quiz' ) ); ?>" class="button button-secondary">
			<span class="dashicons dashicons-plus-alt"></span>
			<?php
			printf(
				// translators: placeholder: Quiz.
				esc_html_x( 'Add your first %s', 'placeholder: Quiz', 'ebox' ),
				\ebox_Custom_Label::get_label( 'quiz' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</a>
	...
	<div class="ld-onboarding-more-help">
		<div class="ld-onboarding-row">
			<div class="ld-onboarding-col">
				...
				printf(
					// translators: placeholder: Quiz.
					esc_html_x( 'Creating a %s', 'placeholder: Quiz', 'ebox' ),
					\ebox_Custom_Label::get_label( 'quiz' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
				);
				?>
					</h3>
				...
				<h3><?php esc_html_e( 'Related help and documentation', 'ebox' ); ?></h3>
					<ul>
						...
						<?php
							echo sprintf(
								// translators: placeholder: Quizzes.
								esc_html_x( '%s Documentation (only available in English)', 'placeholder: Quizzes', 'ebox' ),
								\ebox_Custom_Label::get_label( 'quizzes' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
							);
							?>
						</a></li>
