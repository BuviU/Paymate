...
<section class="ld-onboarding-screen">
	<div class="ld-onboarding-main">
		...
		printf(
			...
			esc_html_x( 'You don\'t have any %s yet', 'placeholder: Questions', 'ebox' ),
		...
		<?php
				printf(
					...
					esc_html_x( 'You can add %1$s when you create a %2$s, or you can choose to add %3$s at any time and add them to a %4$s later.', 'placeholder: %1$s: Questions, %2$s: Quiz, %3$s: Questions, %4$s: Quiz', 'ebox' ),
					\ebox_Custom_Label::get_label( 'questions' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
		...
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=ebox-question' ) ); ?>" class="button button-secondary">
			<span class="dashicons dashicons-plus-alt"></span>
			<?php
			printf(
				// translators: placeholder: Question.
				esc_html_x( 'Add your first %s', 'placeholder: Question', 'ebox' ),
				\ebox_Custom_Label::get_label( 'question' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</a>
				...
				<ul>
					...
					<?php
							echo sprintf(
								...
								esc_html_x( '%1$s %2$s Types [Article] (only available in English)', 'placeholder: Quiz, Question', 'ebox' ),
								\ebox_Custom_Label::get_label( 'quiz' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
								\ebox_Custom_Label::get_label( 'question' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
							);
							?>
					...
					<?php
							echo sprintf(
								// translators: placeholder: Questions.
								esc_html_x( '%s  Documentation (only available in English)', 'placeholder: Questions', 'ebox' ),
								\ebox_Custom_Label::get_label( 'questions' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
							);
							?>
						</a></li>
